...
public class DeleteAdresa {
    ...
    {
        Parent DeleteScene = FXMLLoader.load(getClass().getResource("sampleDeleteAdresa.fxml"));
    ...
    public void stergere(ActionEvent event) throws Exception {
        try {
            ...
            List<Adresa> list = sesionServ.createQuery("from Adresa").getResultList();
            for (Adresa temp : list) {
