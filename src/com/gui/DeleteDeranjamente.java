...
public class DeleteDeranjamente {
    ...
    {
        Parent DeleteScene = FXMLLoader.load(getClass().getResource("sampleDeleteDeranjamente.fxml"));
    ...
    public void stergere(ActionEvent event) throws Exception {
        try {
            ...
            List<Deranjamente> list = sesionServ.createQuery("from Deranjamente").getResultList();
            for (Deranjamente temp : list) {
